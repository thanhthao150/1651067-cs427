...
public class CharacterController2D : MonoBehaviour
{
    ...
    [SerializeField] private Image life1, life2, life3;
    ...
    {
        if (!life3.IsDestroyed()) { Destroy(life3.gameObject); }
        else if (!life2.IsDestroyed()) { Destroy(life2.gameObject); }
        else if (!life1.IsDestroyed())
        {            
